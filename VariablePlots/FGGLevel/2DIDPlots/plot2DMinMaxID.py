...
if (isMC):
  ...
  tree040_0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax040_0","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree040_1.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax040_1","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree040_2.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax040_2","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree040_3.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax040_3","abs(weight)*(CMS_hgg_mass>0)","goff")

  tree4080_0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax4080_0","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree4080_1.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax4080_1","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree4080_2.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax4080_2","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree4080_3.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax4080_3","abs(weight)*(CMS_hgg_mass>0)","goff")

  tree80InfLow_0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfLow_0","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree80InfLow_1.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfLow_1","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree80InfLow_2.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfLow_2","abs(weight)*(CMS_hgg_mass>0)","goff")
  tree80InfLow_3.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfLow_3","abs(weight)*(CMS_hgg_mass>0)","goff")

  if(isGJet or isQCD):
    tree80InfHigh_0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfHigh_0","abs(weight)*(CMS_hgg_mass>0)","goff")
    tree80InfHigh_1.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfHigh_1","abs(weight)*(CMS_hgg_mass>0)","goff")
    tree80InfHigh_2.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfHigh_2","abs(weight)*(CMS_hgg_mass>0)","goff")
    tree80InfHigh_3.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax80InfHigh_3","abs(weight)*(CMS_hgg_mass>0)","goff")
  ...
  tree_0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax_0","CMS_hgg_mass>0 && event%20==0","goff")
  tree_1.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax_1","CMS_hgg_mass>0 && event%20==0","goff")
  tree_2.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax_2","CMS_hgg_mass>0 && event%20==0","goff")
  tree_3.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA):min(dipho_leadIDMVA,dipho_subleadIDMVA)>>minmax_3","CMS_hgg_mass>0 && event%20==0","goff")
...
if (isMC):
  ...
  c1.SaveAs("Data_MinMaxIDMVA.png")
  c1.SaveAs("Data_MinMaxIDMVA.pdf")
