...
sbb0.SetMaximum(15000)
sba0.SetMaximum(15000)
pre0.SetMaximum(15000)
mgg0.SetMaximum(15000)
bkg0.SetMaximum(15000)
...
sb1.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+sbb0","CMS_hgg_mass>0 && event%20==0","goff")
sb2.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+sbb0","CMS_hgg_mass>0 && event%20==0","goff")
sb3.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+sbb0","CMS_hgg_mass>0 && event%20==0","goff")

sb0.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
sb1.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
sb2.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
sb3.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
...
dat1.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")
dat2.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")
dat3.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>+pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")
