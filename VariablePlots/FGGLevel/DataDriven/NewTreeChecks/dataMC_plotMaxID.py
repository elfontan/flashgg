...
#sideband = TFile("/eos/user/e/elfontan/DiPhotonAnalysis/diphotonBDT/reweighting/kest/output_sideband_multiKest1D_AllChunks.root","READ") #Sideband tree with reweight - replaces gjet and QCD        
#sideband = TFile("/eos/user/e/elfontan/DiPhotonAnalysis/diphotonBDT/reweighting/kest/output_sideband_PF_kest1D_AllChunks.root","READ") #Sideband tree with reweight - replaces gjet and QCD        
#sideband = TFile("/eos/user/e/elfontan/DiPhotonAnalysis/diphotonBDT/reweighting/kest/output_sideband_kest1D_AllChunks.root","READ") #Sideband tree with reweight - replaces gjet and QCD        
#sideband = TFile("/afs/cern.ch/work/e/elfontan/private/DiPhotonAnalysis/Sep2023_flashGG/newFlashggRepo/CMSSW_10_6_8/src/flashgg/VariablePlots/FGGLevel/DataDriven/splineOutputs/TEST_output_sideband_maxPhoId_noQCD_threeRanges.root","READ") #Sideband tree with reweight - replaces gjet and QCD        
...
sbb0.SetMaximum(70000)
sba0.SetMaximum(70000)
pre0.SetMaximum(70000)
mgg0.SetMaximum(70000)
bkg0.SetMaximum(70000)

#Sideband/Presel regions: CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)<-0.7 && event%20==0

# DATA in PRESELECTION REGION
#sb0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA)>>sbb0","CMS_hgg_mass>0","goff")
sb0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA)>>sbb0","CMS_hgg_mass>0 && event%20==0","goff")
#sb0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA)>>sbb0","CMS_hgg_mass>0 && event%15==0","goff")

# SIDEBANDS BEFORE REWEIGHTING
#sb0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA)>>sba0","abs(weight)*(CMS_hgg_mass>0)","goff")
#sb0.Draw("max(dipho_leadIDMVA,dipho_subleadIDMVA)>>sba0","abs(weight)*(CMS_hgg_mass>0 && event%17==0)","goff")
...
#c1.SaveAs(outputdir+"/scaled_5PercSB_kest1D_Data_MaxIDComp.png")
#c1.SaveAs(outputdir+"/scaled_5PercSB_kest1D_Data_MaxIDComp.pdf")
c1.SaveAs(outputdir+"/multiKest1D_scaled1p21_lowerBw_5PercSB_Data_MaxIDComp.png")
c1.SaveAs(outputdir+"/multiKest1D_scaled1p21_lowerBw_5PercSB_Data_MaxIDComp.pdf")
