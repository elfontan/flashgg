...
sb0.Draw("dipho_lead_ptoM>>sbb0","CMS_hgg_mass>0 && event%20==0","goff")

sb0.Draw("dipho_lead_ptoM>>sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")

dat0.Draw("dipho_lead_ptoM>>pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")

mgg040_0.Draw("dipho_lead_ptoM>>mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg040_1.Draw("dipho_lead_ptoM>>+mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg040_2.Draw("dipho_lead_ptoM>>+mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg040_3.Draw("dipho_lead_ptoM>>+mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")

mgg4080_0.Draw("dipho_lead_ptoM>>mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg4080_1.Draw("dipho_lead_ptoM>>+mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg4080_2.Draw("dipho_lead_ptoM>>+mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg4080_3.Draw("dipho_lead_ptoM>>+mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")

mgg80inf_0.Draw("dipho_lead_ptoM>>mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg80inf_1.Draw("dipho_lead_ptoM>>+mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg80inf_2.Draw("dipho_lead_ptoM>>+mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg80inf_3.Draw("dipho_lead_ptoM>>+mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
...
c1.Update()
c1.SaveAs(outputdir+"/COMP_dipho_lead_ptoM.png")
c1.SaveAs(outputdir+"/COMP_dipho_lead_ptoM.pdf")
