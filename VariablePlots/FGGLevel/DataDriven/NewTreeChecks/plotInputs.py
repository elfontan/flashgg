...
sbb0 = TH1F("sbb0","sbb0",100,0,0.1) #Max ID in sideband before reweight
sbb0.Sumw2()
sba0 = TH1F("sba0","sba0",100,0,0.1) #Max ID in sideband after reweight - replaces GJet and QCD
sba0.Sumw2()
pre0 = TH1F("pre0","pre0",100,0,0.1) #Max ID in preselection region
pre0.Sumw2()
mgg0l = TH1F("mgg0l","mgg0l",100,0,0.1) #Diphoton MC in preselection region
mgg0l.Sumw2()
mgg0m = TH1F("mgg0m","mgg0m",100,0,0.1) #Diphoton MC in preselection region
mgg0m.Sumw2()
mgg0h = TH1F("mgg0h","mgg0h",100,0,0.1) #Diphoton MC in preselection region
mgg0h.Sumw2()
mgg0 = TH1F("mgg0","mgg0",100,0,0.1) #Diphoton MC in preselection region
mgg0.Sumw2()
...
sb0.Draw("sigmaMwvoM>>sbb0","CMS_hgg_mass>0 && event%20==0","goff")
sb1.Draw("sigmaMwvoM>>+sbb0","CMS_hgg_mass>0 && event%20==0","goff")
sb2.Draw("sigmaMwvoM>>+sbb0","CMS_hgg_mass>0 && event%20==0","goff")
sb3.Draw("sigmaMwvoM>>+sbb0","CMS_hgg_mass>0 && event%20==0","goff")

sb0.Draw("sigmaMwvoM>>sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
sb1.Draw("sigmaMwvoM>>+sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
sb2.Draw("sigmaMwvoM>>+sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")
sb3.Draw("sigmaMwvoM>>+sba0","abs(weight)*(CMS_hgg_mass>0 && event%20==0)","goff")

dat0.Draw("sigmaMwvoM>>pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")
dat1.Draw("sigmaMwvoM>>+pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")
dat2.Draw("sigmaMwvoM>>+pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")
dat3.Draw("sigmaMwvoM>>+pre0","CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7 && event%20==0","goff")

mgg040_0.Draw("sigmaMwvoM>>mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg040_1.Draw("sigmaMwvoM>>+mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg040_2.Draw("sigmaMwvoM>>+mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg040_3.Draw("sigmaMwvoM>>+mgg0l","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")

mgg4080_0.Draw("sigmaMwvoM>>mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg4080_1.Draw("sigmaMwvoM>>+mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg4080_2.Draw("sigmaMwvoM>>+mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg4080_3.Draw("sigmaMwvoM>>+mgg0m","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")

mgg80inf_0.Draw("sigmaMwvoM>>mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg80inf_1.Draw("sigmaMwvoM>>+mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg80inf_2.Draw("sigmaMwvoM>>+mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
mgg80inf_3.Draw("sigmaMwvoM>>+mgg0h","abs(weight)*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)","goff")
...
c1.Update()
c1.SaveAs("Data_SigmaWVComp.png")
c1.SaveAs("Data_SigmaWVComp.pdf")
