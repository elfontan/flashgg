...
# ----------------------
# Data with unweighted events, both regions
data = TFile("/eos/user/e/elfontan/DiPhotonAnalysis/diphotonBDT/NTUPLES_Oct2023/data/EGamma_D.root","READ")
# Sideband tree with reweight - replaces gjet and QCD 
...
var_list = ["dipho_mass", "dipho_lead_ptoM", "dipho_sublead_ptoM", "dipho_leadEta", "dipho_subleadEta", "cosphi", "dipho_leadIDMVA", "dipho_subleadIDMVA", "sigmaMrvoM", "sigmaMwvoM", "vtxprob", "dipho_lead_sigmaEoE", "dipho_sublead_sigmaEoE", "dipho_pt", "dipho_sumpt", "diphoMVA"]
label_list = ["m_{#gamma#gamma}", "Leading photon p_{T}", "Subleading photon p_{T}", "Leading photon #eta", "Sublead photon #eta", "cosphi", "Lead #gamma IDMVA", "Sublead #gamma IDMVA", "#sigma_{RV}/m_{#gamma#gamma}", "#sigma_{WV}/m_{#gamma#gamma}", "Vtx probability", "Leading #gamma #sigma_{E}/E", "Subleading #gamma #sigma_{E}/E", "Diphoton p_{T}", "Diphoton sum p_{T}", "MVA score"]
...
for variable in var_list:
    ...
    sb0.Draw(variable + ">>h_" + variable + "_sba0", "weight*(CMS_hgg_mass>0)*weight_sigmaEOE*weight_ptOverM", "goff")
