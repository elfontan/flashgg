...
# Set Maximum
if (logScale):
    h_sigmaEOE_sba0.SetMaximum(400000)
    h_sigmaEOE_pre0.SetMaximum(400000)
    h_sigmaEOE_mgg0.SetMaximum(400000)
    bkg0.SetMaximum(400000)
else:
    bkg0.SetMaximum(17000)
...
c1.Update()
if (logScale):
    c1.SaveAs(outputdir+"/sigmaEoE_minPhoId_log.png")
    c1.SaveAs(outputdir+"/sigmaEoE_minPhoId_log.pdf")
else:
    c1.SaveAs(outputdir+"/sigmaEoE_minPhoId.png")
    c1.SaveAs(outputdir+"/sigmaEoE_minPhoId.pdf")
