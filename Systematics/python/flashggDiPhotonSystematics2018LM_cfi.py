...
#Aamir: NmatchedEle=0
nmatchedele0Bins = cms.PSet(
    variables = cms.vstring("abs(superCluster.eta)","full5x5_r9"),
    bins = cms.VPSet(
	cms.PSet( lowBounds = cms.vdouble( 0.0, 0.00 ) , upBounds = cms.vdouble( 1.5, 0.85 ) , values = cms.vdouble( 0.9978 ) , uncertainties = cms.vdouble( 0.0039 )  ) ,#EB-Low R9
        cms.PSet( lowBounds = cms.vdouble( 0.0, 0.85 ) , upBounds = cms.vdouble( 1.5, 999. ) , values = cms.vdouble( 0.9996 ) , uncertainties = cms.vdouble( 0.0006 )  ) ,#EB-High R9
        cms.PSet( lowBounds = cms.vdouble( 1.5, 0.00 ) , upBounds = cms.vdouble( 6.0, 0.90 ) , values = cms.vdouble( 1.0 ) , uncertainties = cms.vdouble( 0.0 )  ) ,#EE-Low R9
        cms.PSet( lowBounds = cms.vdouble( 1.5, 0.90 ) , upBounds = cms.vdouble( 6.0, 999. ) , values = cms.vdouble( 1.0023 ) , uncertainties = cms.vdouble( 0.0032 )  ) #EE-High R9
        )
    )

#Aamir : linear cut
linearcutBins = cms.PSet(
    variables = cms.vstring("pt"),
    bins = cms.VPSet(
        cms.PSet(lowBounds = cms.vdouble(0), upBounds = cms.vdouble(5), values = cms.vdouble(0.9988), uncertainties = cms.vdouble(0.0002)),
        cms.PSet(lowBounds = cms.vdouble(5), upBounds = cms.vdouble(10), values = cms.vdouble(0.9988), uncertainties = cms.vdouble(0.0003)),
        cms.PSet(lowBounds = cms.vdouble(10), upBounds = cms.vdouble(20), values = cms.vdouble(1.0000), uncertainties = cms.vdouble(0.0011)),
        cms.PSet(lowBounds = cms.vdouble(20), upBounds = cms.vdouble(30), values = cms.vdouble(1.0021), uncertainties = cms.vdouble(0.0016)),
        cms.PSet(lowBounds = cms.vdouble(30), upBounds = cms.vdouble(50), values = cms.vdouble(1.0035), uncertainties = cms.vdouble(0.0014)),
        cms.PSet(lowBounds = cms.vdouble(50), upBounds = cms.vdouble(80), values = cms.vdouble(1.0122), uncertainties = cms.vdouble(0.0011)),
        cms.PSet(lowBounds = cms.vdouble(80), upBounds = cms.vdouble(120), values = cms.vdouble(1.0245), uncertainties = cms.vdouble(0.0090)),
        cms.PSet(lowBounds = cms.vdouble(120), upBounds = cms.vdouble(999999999), values = cms.vdouble(1.0170), uncertainties = cms.vdouble(0.0030))
      )
    )
...
#with full 2018 dataset from Linda on April 30 for preapproval.  Trigger scale factors for use without HLT applied in MC
leadTriggerScaleBins = cms.PSet(
	...
	#0 <eta < 1.5, R9<0.50 ==> No photons with r9 < 0.5 in the barrel
        ...
        cms.PSet(lowBounds = cms.vdouble(0.50,0.,0.), upBounds = cms.vdouble(0.54,1.5,35),  values = cms.vdouble(0.7809388692), uncertainties = cms.vdouble(0.0048646481,0.0048646481)),
        ...
        cms.PSet(lowBounds = cms.vdouble(0.50,0.,60.), upBounds = cms.vdouble(0.54,1.5,70.), values = cms.vdouble(0.9477220486), uncertainties = cms.vdouble(0.0258457034,0.0258457034)), 
        ...
        cms.PSet(lowBounds = cms.vdouble(0.85,0.,0.), upBounds = cms.vdouble(999,1.5,35.), values = cms.vdouble(0.8612698995), uncertainties = cms.vdouble(0.0032393602,0.0032393602)),
	...
	###ENDCAPS
 	#1.5 <eta < 3, R9<0.9 ==> No low-R9 photons for te seeded leg/leading photon in the Endcaps
        ...
        cms.PSet(lowBounds = cms.vdouble(0.9,1.5,0), upBounds = cms.vdouble(0.93,3.,35.), values = cms.vdouble(0.8336632168), uncertainties = cms.vdouble(0.0058158141,0.0058158141)), 
        ...
        cms.PSet(lowBounds = cms.vdouble(0.93,1.5,70.), upBounds = cms.vdouble(999,3.,90.), values = cms.vdouble(0.9891408232), uncertainties = cms.vdouble(0.0039541238,0.0039541238)),
...
#Aamir: Nmatchedele=0 SFs
nmatchedele0SF = cms.PSet( PhotonMethodName = cms.string("FlashggPhotonWeight"),
          MethodName = cms.string("FlashggDiPhotonFromPhoton"),
          Label = cms.string("nmatchedele0SF"),
          NSigmas = cms.vint32(-1,1),
          OverallRange = cms.string("1"),
          BinList = nmatchedele0Bins,
          Debug = cms.untracked.bool(False),
          ApplyCentralValue = cms.bool(True)
          )
...
#Aamir: linear cut SFs
LinearCutWeight = cms.PSet( MethodName = cms.string("FlashggDiPhotonWeight"),
          Label = cms.string("LinearCutWeight"),
          NSigmas = cms.vint32(-1,1),
          OverallRange = cms.string("pt<99999"),
          BinList = linearcutBins,
          Debug = cms.untracked.bool(False),
          ApplyCentralValue = cms.bool(True)
          )
