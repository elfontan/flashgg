...
indir = "/eos/user/e/elfontan/DiPhotonAnalysis/diphotonBDT/Syst/SigMC_NTUPLES/"
...
#def add_nn_score_to_trees(file_names, tree_names, vars_list, output_file):    
def add_nn_score_to_trees(file_names, tree_names, vars_list):    
    ...
    for file_name in file_names:
        ...
        for tree_name in tree_names:
            ...
            newfile_data = ROOT.TFile(indir + "gghSig_Systematics_noNNLOPS/m"+str(mass_points[idx])+"/out_"+tree_name+".root", "recreate")
...
for m in mass_points:
    file_names_sig = [f"{indir}/ggh_M{m}_noNNLOPS.root"]
    tree_names_sig = [
        f"ggh_{m}_13TeV_UntaggedTag_0",
        f"ggh_{m}_13TeV_UntaggedTag_0_FNUFEBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_FNUFEBUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_FNUFEEDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_FNUFEEUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleGain1EBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleGain1EBUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleGain6EBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleGain6EBUp01sigma", 
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleHighR9EBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleHighR9EBUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleHighR9EEDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleHighR9EEUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleLowR9EBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleLowR9EBUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleLowR9EEDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCScaleLowR9EEUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EBPhiDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EBPhiUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EBRhoDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EBRhoUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EEPhiDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EEPhiUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EERhoDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearHighR9EERhoUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EBPhiDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EBPhiUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EBRhoDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EBRhoUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EEPhiDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EEPhiUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EERhoDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MCSmearLowR9EERhoUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MaterialCentralBarrelDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MaterialCentralBarrelUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MaterialForwardDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MaterialForwardUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MaterialOuterBarrelDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MaterialOuterBarrelUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeHighR9EBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeHighR9EBUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeHighR9EEDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeHighR9EEUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeLowR9EBDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeLowR9EBUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeLowR9EEDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_ShowerShapeLowR9EEUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MvaShiftDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_MvaShiftUp01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_SigmaEOverEShiftDown01sigma",
        f"ggh_{m}_13TeV_UntaggedTag_0_SigmaEOverEShiftUp01sigma"
    ]
     
    #output_file = indir + "gghSig_Systematics/out_ggh_M" + str(m) + ".root"
    #os.makedirs(os.path.dirname(output_file), exist_ok=True)
    #add_nn_score_to_trees(file_names_sig, tree_names_sig, vars_list, output_file)
