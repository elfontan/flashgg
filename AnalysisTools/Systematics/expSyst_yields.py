...
systematics = ["LooseMvaSF", "PreselSF", "electronVetoSF", "TriggerWeight", "FracRVWeight"]
#systematics = ["THU_ggH_Res", "THU_ggH_Mig01", "THU_ggH_Mig12"]
...
for syst in systematics:
    ...
    for mass in range(10, 75, 5):
        ...
        for ev in tree_UL18:
            ...
            if syst == "LooseMvaSF":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.LooseMvaSFDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.LooseMvaSFUp01sigma)
            elif syst == "PreselSF":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.PreselSFDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.PreselSFUp01sigma)
            elif syst == "electronVetoSF":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.electronVetoSFDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.electronVetoSFUp01sigma)
            elif syst == "TriggerWeight":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.TriggerWeightDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.TriggerWeightUp01sigma)
            elif syst == "FracRVWeight":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.FracRVWeightDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.FracRVWeightUp01sigma)
            elif syst == "THU_ggH_Mu":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_MuDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_MuUp01sigma)
            elif syst == "THU_ggH_Res":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_ResDown01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_ResUp01sigma)
            elif syst == "THU_ggH_Mig01":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_Mig01Down01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_Mig01Up01sigma)
            elif syst == "THU_ggH_Mig12":
                h_UL18_dn.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_Mig12Down01sigma)
                h_UL18_up.Fill(ev.CMS_hgg_mass, ev.weight / ev.centralObjectWeight * ev.THU_ggH_Mig12Up01sigma)
