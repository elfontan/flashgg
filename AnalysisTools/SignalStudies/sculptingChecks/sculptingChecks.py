...
h_diphoMass_pre3 = TH1F("h_diphoMass_pre3", "h_diphoMass_pre3", 50, 0, 100)
h_diphoMass_pre4 = TH1F("h_diphoMass_pre4", "h_diphoMass_pre4", 50, 0, 100)
h_diphoMass_pre5 = TH1F("h_diphoMass_pre5", "h_diphoMass_pre5", 50, 0, 100)
h_diphoMass_pre6 = TH1F("h_diphoMass_pre6", "h_diphoMass_pre6", 50, 0, 100)
...
if (sbScenario):
    for ev_dat0 in t_sb0:
        ...
        if (ev_dat0.NNScore > 0.5):
            h_diphoMass_pre3.Fill(ev_dat0.dipho_mass,ev_dat0.weight_allDD)    
        if (ev_dat0.NNScore > 0.6):
            h_diphoMass_pre4.Fill(ev_dat0.dipho_mass,ev_dat0.weight_allDD)    
        if (ev_dat0.NNScore > 0.8):
            h_diphoMass_pre5.Fill(ev_dat0.dipho_mass,ev_dat0.weight_allDD)    
        if (ev_dat0.NNScore > 0.9):
            h_diphoMass_pre6.Fill(ev_dat0.dipho_mass,ev_dat0.weight_allDD)    
else:
    for ev_dat0 in t_dat0:
        #if (c_dat0 == 1000): break                                               
        #print ("######################## Event ", c_dat0)
        c_dat0 += 1
        if (not(sbScenario) and not(c_dat0%20==0)): continue
        ...
        if (ev_dat0.NNScore > 0.9):
            ...
            #h_diphoMass_pre4.Fill(ev_dat0.dipho_mass, ev_dat0.weight)    
...
if (normFactor):
    ...
    h_diphoMass_pre0.SetMaximum(1.5*h_diphoMass_pre0.GetMaximum())
    
else:
    h_diphoMass_pre1.SetMaximum(1.2*h_diphoMass_pre0.GetMaximum())
    h_diphoMass_pre2.SetMaximum(1.2*h_diphoMass_pre0.GetMaximum())
    h_diphoMass_pre3.SetMaximum(1.2*h_diphoMass_pre0.GetMaximum())
    h_diphoMass_pre4.SetMaximum(1.2*h_diphoMass_pre0.GetMaximum())
    h_diphoMass_pre5.SetMaximum(1.2*h_diphoMass_pre0.GetMaximum())
    h_diphoMass_pre6.SetMaximum(1.2*h_diphoMass_pre0.GetMaximum())
...
if (sbScenario):
    leg.AddEntry(h_diphoMass_pre0,"sb events: NN score > 0.2")
    leg.AddEntry(h_diphoMass_pre1,"sb events: NN score > 0.3")
    leg.AddEntry(h_diphoMass_pre2,"sb events: NN score > 0.4")
    leg.AddEntry(h_diphoMass_pre3,"sb events: NN score > 0.5")
    leg.AddEntry(h_diphoMass_pre4,"sb events: NN score > 0.6")    
    leg.AddEntry(h_diphoMass_pre5,"sb events: NN score > 0.8")    
    leg.AddEntry(h_diphoMass_pre6,"sb events: NN score > 0.9")    
else:
    #leg.AddEntry(h_diphoMass_pre0,"All data (presel): NN score > 0.2")
    #leg.AddEntry(h_diphoMass_pre1,"All data (presel): NN score > 0.3")
    #leg.AddEntry(h_diphoMass_pre2,"All data (presel): NN score > 0.4")
    #leg.AddEntry(h_diphoMass_pre3,"All data (presel): NN score > 0.5")
    #leg.AddEntry(h_diphoMass_pre4,"All data (presel): NN score > 0.6")
    #leg.AddEntry(h_diphoMass_pre5,"All data (presel): NN score > 0.7")
    #leg.AddEntry(h_diphoMass_pre6,"All data (presel): NN score > 0.8")
    leg.AddEntry(h_diphoMass_pre0,"5% data (presel): NN score > 0.2")
    leg.AddEntry(h_diphoMass_pre1,"5% data (presel): NN score > 0.3")
    leg.AddEntry(h_diphoMass_pre2,"5% data (presel): NN score > 0.4")
    leg.AddEntry(h_diphoMass_pre3,"5% data (presel): NN score > 0.5")
    leg.AddEntry(h_diphoMass_pre4,"5% data (presel): NN score > 0.6")
    leg.AddEntry(h_diphoMass_pre5,"5% data (presel): NN score > 0.8")
    leg.AddEntry(h_diphoMass_pre6,"5% data (presel): NN score > 0.9")
leg.SetLineWidth(0)
leg.Draw("same")
...
if (sbScenario and normFactor):
    c1.SaveAs(outputdir+"/diphoMass_sb_sculptingCheck_norm1.png")
    c1.SaveAs(outputdir+"/diphoMass_sb_sculptingCheck_norm1.pdf")
elif (normFactor):
    #c1.SaveAs(outputdir+"/diphoMass_allDataPreselOnly_sculptingCheck_norm1.png")
    #c1.SaveAs(outputdir+"/diphoMass_allDataPreselOnly_sculptingCheck_norm1.pdf")
    c1.SaveAs(outputdir+"/diphoMass_5percentDataPreselOnly_sculptingCheck_norm1.png")
    c1.SaveAs(outputdir+"/diphoMass_5percentDataPreselOnly_sculptingCheck_norm1.pdf")
elif(sbScenario):
    c1.SaveAs(outputdir+"/diphoMass_sb_sculptingCheck.png")
    c1.SaveAs(outputdir+"/diphoMass_sb_sculptingCheck.pdf")
else:
    c1.SaveAs(outputdir+"/diphoMass_5percentDataPreselOnly_sculptingCheck.png")
    c1.SaveAs(outputdir+"/diphoMass_5percentDataPreselOnly_sculptingCheck.pdf")
