...
//write the datacard
void noNNLOPS_redTheory_manual_slidingdatacard10p_creation_cat1(){
  for (int mass=10; mass<71; mass++){
    ...
    TString cat_n;
    char inputShape[200];
    sprintf(inputShape,"noNNLOPS_redTheory_datacards_sliding10pdata_syst/sliding_"+mass_s+"cat1.txt");
    ...
    newcardShape << Form("------------------------------------------      \n");
    newcardShape << Form("shapes     sig cat1 ../ws_sig/CMS-HGG_sigfit_LMAnalysis_Jul2024_newSignalNtuplesNoNNLOPS_4Cat_gghSystFixed_2018_GG2H_2018_UntaggedTag_1.root wsig_13TeV:hggpdfsmrel_GG2H_2018_UntaggedTag_1_13TeV\n");
    newcardShape << Form("shapes     bkg cat1 ../ws_sliding10pdata_bern4/CMS-HGG_"+mass_s+"multipdf_UntaggedTag_1.root multipdf:CMS_hgg_UntaggedTag_1_2018_13TeV_bkgshape\n");
    newcardShape << Form("shapes     data_obs cat1 ../ws_sliding10pdata_bern4/CMS-HGG_"+mass_s+"multipdf_UntaggedTag_1.root multipdf:roohist_data_mass_UntaggedTag_1\n");
    newcardShape << Form("bin                 cat1\n");
    newcardShape << Form("observation         -1\n");
    newcardShape << Form("------------------------------------------      \n");
    newcardShape << Form("bin               cat1           cat1      \n");
    newcardShape << Form("process           sig            bkg            \n");
    newcardShape << Form("process           -1               1            \n");
    newcardShape << Form("rate              5440            1            \n");
    newcardShape << Form("------------------------------------------      \n");
    newcardShape << Form("pdfindex_UntaggedTag_1_2018_13TeV discrete      \n");
    newcardShape << Form("------------------------------------------      \n");
    newcardShape << Form("lumi                lnN             1.015    -    \n");
    newcardShape << Form("nvtx_rew                lnN             1.007    -    \n");
    newcardShape << Form("CMS_hgg_LooseMvaSF_2018   lnN   1.002    -    \n");
    newcardShape << Form("CMS_hgg_PreselSF_2018   lnN   1.052    -    \n");
    newcardShape << Form("CMS_hgg_electronVetoSF_2018   lnN   1.007    -    \n");
    newcardShape << Form("CMS_hgg_TriggerWeight_2018   lnN   1.005    -    \n");
    newcardShape << Form("CMS_hgg_SigmaEOverEShift_2018   lnN   1.072    -    \n");
    newcardShape << Form("CMS_hgg_phoIdMva_2018   lnN   1.052    -    \n");
    newcardShape << Form("------------------------------------------      \n");
    newcardShape << Form("QCDscale_ggH   lnN   1.023/0.957   -    \n");
    newcardShape << Form("alphaS_ggH   lnN   1.034    -    \n");
    newcardShape << Form("CMS_hgg_scaleWeight_0    lnN   1.012/0.992    -    \n");
    newcardShape << Form("CMS_hgg_scaleWeight_1    lnN   0.993/1.006    -    \n"); 
    newcardShape << Form("CMS_hgg_scaleWeight_2    lnN   1.004/0.997    -    \n");
    newcardShape << Form("------------------------------------------      \n");
