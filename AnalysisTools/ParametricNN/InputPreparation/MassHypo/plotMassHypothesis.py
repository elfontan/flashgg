...
for variable in var_list:
    ...
    rp.Draw("ep")
    rp.SaveAs("ratios_"+variable+".root")
    ...
    c1.Update()
    c1.SaveAs(outputdir+"/"+variable+"_SigBkgComp_flatteningBkg_v5.png")
    c1.SaveAs(outputdir+"/"+variable+"_SigBkgComp_flatteningBkg_v5.pdf")
