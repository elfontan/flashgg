...
for variable in var_list:
    ...
    sig0_10.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_15.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_20.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_25.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_30.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_35.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_40.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_45.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_50.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_55.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_60.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_65.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_70.Draw(variable + ">>+h_" + variable + "_sig0", "weight*w_signal*dipho_hypwgt_near*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
...
for variable in var_list:
    ...
    sig0.SaveAs("ratios_dipho_masshyp_norm.root")
    ...
    c1.Update()
    c1.SaveAs(outputdir+"/"+variable+"_SigBkgWgt_flatteningBkg_v4.png")
    c1.SaveAs(outputdir+"/"+variable+"_SigBkgWgt_flatteningBkg_v4.pdf")
