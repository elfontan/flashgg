...
# ----------------------
para = TFile("output_ParaDDFull.root","READ")
...
label_list = ["m_{#gamma#gamma}", "m_{hyp,near}"]
...
# ----------------------------------------------------------------------
binning_info = { 
    var_list[0]: (32, 0., 80.),   #dipho_mass 
    var_list[1]: (32, 0., 80.),   #dipho_masshyp_near
}
...
for variable in var_list:
    ...
    sig0_15.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_20.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_25.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_30.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_35.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_40.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_45.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_50.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_55.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_60.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    #sig0_65.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
    sig0_70.Draw(variable + ">>+h_" + variable + "_sig0", "weight*(CMS_hgg_mass>0 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>-0.7)", "goff")
...
for variable in var_list:
    ...
    c1.Update()
    c1.SaveAs(outputdir+"/"+variable+"_SigBkgComp_noWSig_flatteningBkg_v5.png")
    c1.SaveAs(outputdir+"/"+variable+"_SigBkgComp_noWSig_flatteningBkg_v5.pdf")
