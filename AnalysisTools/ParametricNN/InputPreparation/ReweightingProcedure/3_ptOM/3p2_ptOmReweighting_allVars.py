...
for variable in var_list:
    ...
    if (cr_phoId0p0):
        ...
        sb0.Draw(variable + ">>h_" + variable + "_sba0", "weight*weight_ptOverM*weight_sigmaEOE* (CMS_hgg_mass>=10 && CMS_hgg_mass<75 && min(dipho_leadIDMVA>0.9,dipho_subleadIDMVA)>0.9)", "goff")
        ...
        sb0.Draw(variable + ">>h_" + variable + "_sba0", "weight*weight_ptOverM*weight_sigmaEOE * (CMS_hgg_mass>=10 && CMS_hgg_mass<75)", "goff")
