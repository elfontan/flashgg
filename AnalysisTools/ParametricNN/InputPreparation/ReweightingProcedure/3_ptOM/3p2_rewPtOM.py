...
for ev_sb0 in sb0:
    ...
    if (preRew):
        ...
        if (ev_sb0.dipho_leadIDMVA <= ev_sb0.dipho_subleadIDMVA and min(ev_sb0.dipho_leadIDMVA, ev_sb0.dipho_subleadIDMVA)>-0.7):
            fill_histograms(h_ptToM_min_sba0, ev_sb0.dipho_lead_ptoM, ev_sb0.weight*ev_sb0.weight_sigmaEOE*ev_sb0.weight_ptOverM)
            fill_histograms(h_ptToM_max_sba0, ev_sb0.dipho_sublead_ptoM, ev_sb0.weight*ev_sb0.weight_sigmaEOE*ev_sb0.weight_ptOverM)
        elif (ev_sb0.dipho_leadIDMVA > ev_sb0.dipho_subleadIDMVA and min(ev_sb0.dipho_leadIDMVA, ev_sb0.dipho_subleadIDMVA)>-0.7):
            fill_histograms(h_ptToM_min_sba0, ev_sb0.dipho_sublead_ptoM, ev_sb0.weight*ev_sb0.weight_sigmaEOE*ev_sb0.weight_ptOverM)
            fill_histograms(h_ptToM_max_sba0, ev_sb0.dipho_lead_ptoM, ev_sb0.weight*ev_sb0.weight_sigmaEOE*ev_sb0.weight_ptOverM)
...
# Set Maximum
if (logScale):
    bkg0_min.SetMaximum(40.0*h_ptToM_min_pre0.GetMaximum())
    bkg0_max.SetMaximum(40.0*h_ptToM_max_pre0.GetMaximum())
else:
    bkg0_min.SetMaximum(1.3*h_ptToM_min_pre0.GetMaximum())
    bkg0_max.SetMaximum(1.3*h_ptToM_max_pre0.GetMaximum())
...
h_ptToM_min_sba0.GetYaxis().SetTitle("Events")
...
leg.AddEntry(h_ptToM_min_sba0,"#gamma-jet and jet-jet (pf+ff DD)")
leg.AddEntry(h_ptToM_min_mgg0,"#gamma#gamma MC")
...
if (logScale and preRew):                                                                                                                                            
    c1_min.SaveAs(outputdir+"/ptOverM_preReweighting_minPhoId_log.png")
    c1_min.SaveAs(outputdir+"/ptOverM_preReweighting_minPhoId_log.pdf")
elif (logScale):
...
h_ptToM_max_sba0.GetYaxis().SetTitle("Events")
...
c1_max.Update()
if (logScale and preRew):                                                                                                                                            
    c1_max.SaveAs(outputdir+"/ptOverM_preReweighting_maxPhoId_log.png")
    c1_max.SaveAs(outputdir+"/ptOverM_preReweighting_maxPhoId_log.pdf")
elif (logScale):
    c1_max.SaveAs(outputdir+"/ptOverM_reweighted_maxPhoId_log.png")
