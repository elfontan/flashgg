...
# python3  0p1_plotMinID_preRewighting.py --log True  --outdir /eos/user/e/elfontan/www/Hgg_veryLowMass_AN/inputPreparation/0_TFracFitter/
...
sb0.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>sbb0","CMS_hgg_mass<75","goff")
sb0.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>sba0","weight*(CMS_hgg_mass<75)","goff")
dat0.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>pre0","CMS_hgg_mass<75 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>=-0.7 && event%20==0","goff")
mgg080.Draw("min(dipho_leadIDMVA,dipho_subleadIDMVA)>>mgg0","weight*(CMS_hgg_mass<75 && min(dipho_leadIDMVA,dipho_subleadIDMVA)>=-0.7)","goff")
...
mgg0.SetMaximum(4.*pre0.GetMaximum())
sba0.SetMaximum(4.*pre0.GetMaximum())
sbb0.SetMaximum(4.*pre0.GetMaximum())
bkg0.SetMaximum(4.*pre0.GetMaximum())
...
rp.SetXTitle("Minimum #gamma ID MVA")
...
c1.Update()
if (logScale):
    c1.SaveAs(outputdir+"/minPhoID_preReweighting_log.png")
    c1.SaveAs(outputdir+"/minPhoID_preReweighting_log.pdf")
else:
    c1.SaveAs(outputdir+"/minPhoID_preReweighting.png")
    c1.SaveAs(outputdir+"/minPhoID_preReweighting.pdf")
