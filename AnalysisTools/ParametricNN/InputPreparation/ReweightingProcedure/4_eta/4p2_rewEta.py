...
argparser.add_argument('--pre', dest='pre', default=False, help='Before reweighting')
...
if (preRew):
    sideband = TFile("/eos/user/e/elfontan/DiPhotonAnalysis/Apr2024_flashggNtuples/bkg/reweightedSb/sb_data2018_plusSigmaEOEPt.root","READ")
else:
    sideband = TFile("/eos/user/e/elfontan/DiPhotonAnalysis/Apr2024_flashggNtuples/bkg/reweightedSb/sb_data2018_plusSigmaEOEPtEta.root","READ")
...
h_eta_pre0 = TH1F("h_eta_pre0", "h_eta_pre0", 60, -3.0, 3.0)
h_eta_mgg0 = TH1F("h_eta_mgg0", "h_eta_mgg0", 60, -3.0, 3.0)
bkg0_eta= THStack("bkg0_eta","bkg0_eta")
...
for ev_sb0 in sb0:
    ...
    if (preRew):
        ...
        if (ev_sb0.dipho_leadIDMVA <= ev_sb0.dipho_subleadIDMVA):
            h_eta_sba0.Fill(ev_sb0.dipho_leadEta, ev_sb0.weight*ev_sb0.weight_sigmaEOE*ev_sb0.weight_ptOverM*ev_sb0.weight_eta)
        elif (ev_sb0.dipho_leadIDMVA > ev_sb0.dipho_subleadIDMVA):
            h_eta_sba0.Fill(ev_sb0.dipho_subleadEta, ev_sb0.weight*ev_sb0.weight_sigmaEOE*ev_sb0.weight_ptOverM*ev_sb0.weight_eta)
...
h_eta_sba0.GetYaxis().SetTitle("Events")
h_eta_sba0.GetYaxis().SetTitleSize(25)
h_eta_sba0.GetYaxis().SetTitleFont(43)
h_eta_sba0.GetYaxis().SetTitleOffset(2.25)
h_eta_sba0.GetYaxis().SetLabelFont(43)
h_eta_sba0.GetYaxis().SetLabelOffset(0.01)
h_eta_sba0.GetYaxis().SetLabelSize(25)
h_eta_sba0.SetLineColor(kYellow-4)
h_eta_sba0.SetFillColorAlpha(kYellow-4,0.8)
h_eta_sba0.SetLineWidth(2)

h_eta_mgg0.SetLineColor(kOrange-4)
h_eta_mgg0.SetFillColorAlpha(kOrange-4,0.8)
h_eta_mgg0.SetLineWidth(2)

bkg0_eta.Add(h_eta_mgg0)
bkg0_eta.Add(h_eta_sba0)

h_eta_sba0.GetXaxis().SetLabelOffset(1.5)
h_eta_mgg0.GetXaxis().SetLabelOffset(1.5)
h_eta_sba0.GetXaxis().SetLabelSize(0)
h_eta_mgg0.GetXaxis().SetLabelSize(0)
bkg0_eta.Draw("histo")

h_eta_mgg0.SetMaximum(10.*h_eta_pre0.GetMaximum())
h_eta_sba0.SetMaximum(10.*h_eta_pre0.GetMaximum())
bkg0_eta.SetMaximum(10.*h_eta_pre0.GetMaximum())

h_eta_pre0.SetLineWidth(2)
h_eta_pre0.SetLineColorAlpha(kBlack,0.8)
#h_eta_pre0.SetLineColorAlpha(kOrange+9,0.8)
h_eta_pre0.GetXaxis().SetLabelSize(0)
h_eta_pre0.Draw("epsame")

leg = TLegend(0.2,0.65,0.7,0.88)
leg.AddEntry(h_eta_sba0,"#gamma-jet and jet-jet (pf+ff DD)")
leg.AddEntry(h_eta_mgg0,"#gamma#gamma MC")
leg.AddEntry(h_eta_pre0,"Preselection Region")
leg.SetLineWidth(0)
leg.Draw("same")
...
#define ratio plot                                                                                                                              
rp = TH1F(h_eta_pre0.Clone("rp")) #clone the preselection region                                                                                         
rp.SetLineColor(kBlack)
rp.SetMinimum(0.5)
rp.SetMaximum(1.9)
rp.SetStats(0)
rp.Divide(h_eta_sba0+h_eta_mgg0) #divide by sideband+mgg                                                                                                     
...
rp.SetXTitle("Minimum #gamma ID MVA #eta")
...
if (logScale and preRew):
    c1.SaveAs(outputdir+"/minPhoId_eta_preReweighting_log.png")
    c1.SaveAs(outputdir+"/minPhoId_eta_preReweighting_log.pdf")
elif (logScale):
    c1.SaveAs(outputdir+"/minPhoId_eta_reweighted_log.png")
    c1.SaveAs(outputdir+"/minPhoId_eta_reweighted_log.pdf")
else:
    c1.SaveAs(outputdir+"/minPhoId_eta_reweighted.pdf")
    c1.SaveAs(outputdir+"/minPhoId_eta_reweighted.png")

print("MGG: ", h_eta_mgg0.Integral())
print("Reweighted eta minPhoId: ", h_eta_sba0.Integral())
print("Preselection region: ", h_eta_pre0.Integral())
