...
def main(process_number):
    ...
    output_file = f"/afs/cern.ch/work/e/elfontan/private/DiPhotonAnalysis/Sep2023_flashGG/CMSSW_12_6_5/src/kest1D_condor_submission/OUTPUT_FILES_NEW/output_sideband_kest1D_PF_chunk{process_number}.root"
    ...
    kest0 = w.pdf("kestML1p5_minPhoId_0") # MaxPhoId = [-0.7,-0.5]       
    kest1 = w.pdf("kestML1p5_minPhoId_1") # MaxPhoId = [-0.5,-0.3]
    kest2 = w.pdf("kestML1p5_minPhoId_2") # MaxPhoId = [-0.3,-0.2]
    kest3 = w.pdf("kestML1p5_minPhoId_3") # MaxPhoId = [-0.2,-0.1]       
    kest4 = w.pdf("kestML1p5_minPhoId_4") # MaxPhoId = [-0.1,0.0]       
    kest5 = w.pdf("kestML1p5_minPhoId_5") # MaxPhoId = [0.0,0.1]
    kest6 = w.pdf("kestML1p5_minPhoId_6") # MaxPhoId = [0.1,0.2]
    kest7 = w.pdf("kestML1p5_minPhoId_7") # MaxPhoId = [0.2,0.3]
    kest8 = w.pdf("kestML1p5_minPhoId_8") # MaxPhoId = [0.3,0.4]
    kest9 = w.pdf("kestML1p5_minPhoId_9") # MaxPhoId = [0.4,0.5]
    kest10 = w.pdf("kestML1p5_minPhoId_10") # MaxPhoId = [0.5,0.6]        
    kest11 = w.pdf("kestML1p5_minPhoId_11") # MaxPhoId = [0.6,0.7] 
    kest12 = w.pdf("kestML1p5_minPhoId_12") # MaxPhoId = [0.7,0.8]        
    kest13 = w.pdf("kestML1p5_minPhoId_13") # MaxPhoId = [0.8,0.9]       
    kest14 = w.pdf("kestML1p5_minPhoId_14") # MaxPhoId = [0.9,0.95]        
    kest15 = w.pdf("kestML1p5_minPhoId_15") # MaxPhoId = [0.95,1.0]       
