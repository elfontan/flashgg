...
for i in range(10,75,5):
  ...
  mca_sigfile = TFile("output/pnn"+str(i)+".root","READ")
  mca_sighist = mca_sigfile.Get("pnnr")
  mca_sigeffden = mca_sighist.Integral()

  mca_bkgfile = TFile("output/pnn"+str(i)+"data.root","READ")
  mca_bkghist = mca_bkgfile.Get("pnnr")
