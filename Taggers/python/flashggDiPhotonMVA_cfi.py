...
flashggDiPhotonMVA = cms.EDProducer('FlashggDiPhotonMVAProducer',
                                    ...
                                    diphotonMVAweightfileDefLowMass = cms.FileInPath("flashgg/Taggers/data/Flashgg_DiPhoton_2017LowMass_Ignore02_RunIIFall17-3_1_X.weights.xml"),
                                    diphotonMVAweightfileNewMcBdt = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_MCBDT.weights.xml"),
                                    diphotonMVAweightfileDataBdt = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_DataBDT.weights.xml"),
